...
@JsonIgnoreProperties(value = {"plannedIssueDate", "kind", "responsibleUser", "files", "domain", "securityGroup", "removed", "favourite","id","classification","documentName","type","noOfFiles","activities","comments"})
