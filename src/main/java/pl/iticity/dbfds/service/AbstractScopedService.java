...
public abstract class AbstractScopedService<MODEL,REPO extends MongoRepository<MODEL,String> & ScopedRepository<MODEL>> extends AbstractService<MODEL,REPO> implements ScopedService<MODEL> {
